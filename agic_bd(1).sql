...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : jeu. 13 nov. 2025 à 08:11
...
CREATE TABLE IF NOT EXISTS `compte` (
  ...
  `membre_id_membre` bigint DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `sessions` (
  `id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_membre` bigint UNSIGNED DEFAULT NULL,
  `ip_address` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `user_agent` text COLLATE utf8mb4_unicode_ci,
  `payload` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `last_activity` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `sessions_id_membre_index` (`id_membre`),
...
INSERT INTO `users` (`id_membre`, `date_first_inscription`, `date_naissance`, `demissionnaire`, `login`, `photo`, `prenom_membre`, `sexe_membre`, `statutgeographique`, `nom_membre`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
